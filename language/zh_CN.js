const zh = {
  ...
  "index": {
    ...
    "sevices": {
      ...
      "mobile": {
        "title": "移动应用",
        "list": ["iOS", "Android", "混合开发", "小程序"]
      },

      "webapp": {
        "title": "网络应用",
        "list": ["媒体和内容", "企业后台管理", "电子商务"]
      }
    },
    ...
    "scheme": {
      ...
      "list": [{
        ...
        "text": "我们坚持所做的事情。发布后我们将提供一年的免费维护支持。"
      }, {
        "title": "免费报价",
  ...
  "services": {
    "banner": {
      "title1": "在此过程的每个步骤中，我们都与客户紧密合作。",
      "title2": "从设计到开发，我们采取平衡的方法，每个部分都受到同等的关注。"
    },
    ...
    "territory": {
      ...
      "mobile": {
        "title": "移动应用",
        "desc": "我们为iOS，Android和混合移动平台开发解决方案，每种解决方案都能满足不同的细分市场和特定的客户需求。",
        "list": [{
            "title": "iOS",
            "item": [{
                "name": "Swift",
      ...
      "webapp": {
        "title": "网络应用",
        "desc": "我们在为各种基于Web的应用程序构建方面拥有丰富的经验，并与客户一起确定理想的框架和平台。",
        "list": [{
            "title": "电子商务",
            "item": [{
                "name": "Magento",
    ...
    "process": {
      ...
      "list": [{
        ...
        "item": [{
          "title": "了解产品",
          "desc": "我们与您的设计，产品和工程团队紧密合作。",
          "icon": "\ue600"
        }, {
          "title": "了解用户",
          "desc": "我们以客户为原型, 并以体验为核心, 以简单的心态进行开发",
          "icon": "\ue649"
        }]
      }, {
        "h1": "UI/UX 设计",
        "item": [{
          "title": "线框图和经验",
          "desc": "使用每项功能，我们都会反复进行，直到在4次或更短的屏幕点击时间内即可完成任何操作。",
          "icon": "\ue61e"
        }, {
          "title": "设计与品牌匹配",
          "desc": "根据您的品牌，要格外小心，以确保每个屏幕，动画和按钮都一致，优雅且精致。",
          "icon": "\ue684"
        }]
      }, {
        "h1": "发展历程",
        "item": [{
          "title": "原型制作",
          "desc": "在开发之前和开发过程中基于反馈进行迭代可确保应用程序达到并超过期望。",
          "icon": "\ue619"
        }, {
          "title": "测试中",
          "desc": "我们花费数百小时来测试多种设备的质量保证。",
          "icon": "\ue602"
        }, {
          "title": "生产和迭代",
          "desc": "我们采用策略来捕获用户的诚实反馈，而不会对应用商店的评分产生负面影响。",
          "icon": "\ue618"
        }]
      }]
    }
